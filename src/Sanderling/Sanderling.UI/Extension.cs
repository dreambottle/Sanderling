...
namespace Sanderling.UI
{
    static public class Extension
    {
        ...
        static public StatusIcon.StatusEnum MemoryMeasurementLastStatusEnum(this FromProcessMeasurement<IMemoryMeasurement> measurement) =>
            MemoryMeasurementLastStatusEnum(measurement, Environment.TickCount - 8000);
